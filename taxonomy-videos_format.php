...
?>
	...
	<?php
		if( $terms = get_terms( array( 'taxonomy' => 'videos_genres', 'orderby' => 'name' ) ) ) : 
 			echo '<select name="categoryfilter" id="posss"><option value="">Todos los formatos</option>';
	...
	<div class="switch-field">
      <input type="radio" id="switch_left" name="fechaentrada" value="yes" checked/>
      <label for="switch_left">Recientes</label>
      <input type="radio" id="switch_right" name="fechaentrada" value="no" />
