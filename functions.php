...
// Modificación en COMENTARIOS 
include_once( get_stylesheet_directory(). '/retinafunciones/comentarios.php');

// Funciones relacionadas con peliculas 
/* 
getYouTubeId()
*/
include_once( get_stylesheet_directory(). '/retinafunciones/peliculas.php');

//Funciones relacionadas con personas
include_once( get_stylesheet_directory(). '/retinafunciones/personas.php');
